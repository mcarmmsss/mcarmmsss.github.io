const decks = {
  ...
  factors_affecting_style: [
    ["Geography and Climate", "Tropical heat, humidity, typhoons, varied terrain influence elevation, ventilation, materials."],
    ["Availability of Resources", "Timber, bamboo, nipa, rattan, minerals; affects durability and design."],
    ["Religion", "Catholic majority; Islam and others influence sacred architecture and rituals."],
    ["Socio-economic Conditions", "Class structure, trade economy, cost of living shape housing scale."],
    ["Historical and Political Events", "Colonization, wars, disasters produce hybrid rebuilding styles."],
    ["Trade and Commerce", "Introduces foreign materials and design ideas."],
    ["Earlier Styles", "Vernacular foundations evolve into colonial hybrids."],
    ["Technology Level", "From bamboo joinery to reinforced concrete systems."]
  ],
  ...
  id34_baroque_furniture_Ageneral: [
    ...
    ["Pietra Dura", "Inlay using marvel, granite, and other semiprecious stones on stone surfaces like marble"],
    ["Ebonizing", "Make timber look like ebony"],
    ["Lacquer work", "Lacquer surface on which flar or relief designs are drawn"],
    ...
    ["Churrigueresque", "Works of the Churrieguera family of stuccoists in Spain"]
   ...
   id34_baroque_furniture_italian: [
   ...
   id34_baroque_furniture_french: [
     ...
     ["Fauteil", "Open Arm chair, exposed wooden frame, upholstered in silk or tapestry."],
     ...
     ["Chaise Lounge", "daybed and placed at the food of four poster bed, used for napping"],
     ["Miroir Dore", "Gilded mirror with heavy acanthus carvings and monumental scale"],
  ],
    id34_baroque_furniture_english: [
      ...
      ["Gateleg table", "Oval or orund drop leaf table supported by multiple turned legs"],
      ["Caned High-Back Chair", "High-backed chair with woven cane panels"],
      ["Chaise/Couch], Uplholstered Reclining seat"],
      ...
      ["Oyster Veneer Chest", "Drawer fronts decorated with cross secions of small wood branches"]
  ],
  id34_baroque_maybe: [
    ...
    ["Aristocrastic domestic", "English Symbolism"],
